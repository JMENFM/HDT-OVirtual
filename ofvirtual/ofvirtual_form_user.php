...
<head>
  <title>Sign In</title>
  <link rel="stylesheet" href="../_lib/libraries/grp/lib_login/css/DisenioLoginOficinaVirtual.css" />
...
?>
  ...
  <script type="text/javascript" src="../_lib/libraries/grp/lib_login/js/error.js">
  ...
  <div class="page">
    <div class="container">
        <div class="card card-container">
          <div class="cabecera">
            <img id="profile-img" class="profile-img-card" src="../_lib/libraries/grp/lib_login/img/hdt_login_peq.png"
              style="padding-left: 30px; padding-top: 10px; padding-bottom: 10px; width: 25%;" />
          
          </div>
          <h1 id="profile-name" class="profile-name-card" style = "color:#006a8e">Oficina Virtual</h1>
          <form class="form-signin" action=""  name="F1" method="post" 
               action="./" 
               target="_self">
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
            ...
            <!--SC_FIELD_INFO_language-->
            <span id="reauth-email" class="reauth-email">Usuario</span>
            <input type="text" id="inputEmail" class="form-control  sc-js-input "  name="login" id="id_sc_field_login" value="<?php echo $this->form_encode_input($login) ?>"  alt="{datatype: 'text', maxLength: 190, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" 
              placeholder="" name="username" >
            <span id="reauth-password" class="reauth-password">Contraseña</span>
            ...
            <input class="btn btn-lg btn-primary btn-block btn-signin" formmethod="post" type="submit"
              value="Iniciar sesión"  onclick="nm_atualiza('alterar');"  />
            <hr>
...
?>
            ...
            <span class="infosec" style="text-align: left;">Seguridad</span>
            <span class="infosec" style="color:#C00000 ; margin-bottom: 20px !important;">
              Advertencia: al iniciar sesión en esta página web, confirma que este equipo cumple la directiva de
              seguridad de la organización.
            </span>
            <span class="infosec">
              Para proporcionar protección contra accesos no autorizados, el tiempo de espera de su sesión de Acceso al
              Portal de Servicios se agotará automáticamente tras un período de inactividad. Si finaliza la sesión,
              actualice el explorador y vuelva a iniciar sesión.
            </span>

            <hr>
            

            <div class="bloqueAlerta">
  ...
  <script type="text/javascript" src="../_lib/libraries/grp/lib_login/js/error.js"></script>
</body>
